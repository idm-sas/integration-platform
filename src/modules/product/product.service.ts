...
export class ProductService {
  ...
  private toDto(product: Product, includePrices: boolean) {
    return {
      ...
      SAPProductCode: product.partner_code,
      Description: product.description ?? null,
      Unit: product.uom,
      Deactivated: product.isActive,
      Category: product.category?.id,
      CategoryERPId: product.category?.name,
      Category2: product.group2,
      Image: product.imageUrl,
      createdAt: product.createdAt,
      lastUpdateAt: product.syncedAt,
      ...(includePrices && {
